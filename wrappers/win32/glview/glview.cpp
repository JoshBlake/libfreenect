...
freenect_rgb_format requested_format = FREENECT_FORMAT_RGB;
freenect_rgb_format current_format = FREENECT_FORMAT_RGB;
...
void DrawGLScene()
{
	...
	if (current_format == FREENECT_FORMAT_RGB)
...
void *freenect_threadfunc(void *arg)
{
	...
	freenect_set_rgb_format(f_dev, current_format);
...
//		freenect_get_mks_accel(state, &dx, &dy, &dz);
		...
		if (requested_format != current_format) {
			...
			freenect_set_rgb_format(f_dev, requested_format);
			freenect_start_rgb(f_dev);
...
int main(int argc, char **argv)
{
	...
	rgb_back = (uint8_t*)malloc(640*480*4);
	rgb_mid = (uint8_t*)malloc(640*480*4);
	rgb_front = (uint8_t*)malloc(640*480*4);
